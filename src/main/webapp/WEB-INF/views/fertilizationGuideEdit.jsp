                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" id="title" value="3rd Week of Pregnancy" placeholder="Recipe title">
                        </div>

                        <div class="form-group form-img-thumbnail">
                            <a data-fancybox="gallery" href="images/guide.jpg"><img src="images/guide.jpg" alt="Roasted Carrot Soup" class="img-thumbnail"></a>
